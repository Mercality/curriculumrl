...
class RubyWinSourcesControllerTest < ActionController::TestCase
  ...
  test "should create ruby_win_source" do
    assert_difference('RubyWinSource.count') do
      post :create, ruby_win_source: {  author: @ruby_win_source. author,  url: @ruby_win_source. url, name: @ruby_win_source.name }
    end
  ...
  test "should update ruby_win_source" do
    patch :update, id: @ruby_win_source, ruby_win_source: {  author: @ruby_win_source. author,  url: @ruby_win_source. url, name: @ruby_win_source.name }
    assert_redirected_to ruby_win_source_path(assigns(:ruby_win_source))
  end
